...
**
** IPC_MBOPEN will open a new URL in the minibrowser. if url is NULL, it will o
pen the Minibrowser window.
*/
...
**
** IPC_INETAVAILABLE will return 1 if the Internet connection is available for 
Winamp.
*/
...
**
** IPC_UPDTITLE will ask Winamp to update the informations about the current ti
tle.
*/
...
**
** IPC_MBOPENREAL works the same as IPC_MBOPEN except that it will works even i
f 
...
#define WINAMP_PAUSE_BUTTON 40046
#define WINAMP_STOP_BUTTON 40047
#define WINAMP_FADE_STOP_BUTTON 40147
