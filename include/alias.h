 ...
 *
 * @(#)$Id: alias.h,v 1.1.1.1 2000/07/16 12:58:53 edwards Exp $
 */
...
extern	void 	add_var_alias      	(char *, char *, int);
extern	void 	add_local_alias    	(char *, char *, int);
 ...
 */
extern	char *	expand_alias 		(const char *, const char *, int *, char **);
 ...
 */
extern	char *	parse_inline 		(char *, const char *, int *);
...
extern	void	do_stack_alias 		(int, char *, int);
	char	*next_unit		(char *, const char *, int *, int);
