...
REM to get a better working TekNap
REM copy cygwindevo.dll to c:\windows
REM mkdir c:\TekNap and copy TekNap.exe to c:\TekNap
...
REM this is so that TekNap knows where to find it's bwaprc file and where to
REM download any files to. Make sure c:\TekNap exists. Also notice that this
