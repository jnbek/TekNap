 ...
 * See the COPYRIGHT file, or do a HELP IRCII COPYRIGHT 
 * $Id: keys.c,v 1.1.1.1 2000/08/27 06:24:20 edwards Exp $ 
 */
...
extern void switch_channels(char, char *);
...
static KeyMapNames 	key_names[] =
{
	...
	{ "JOIN_LAST_INVITE",		join_lastinvite			},
...
static void 	new_metamap (int which)
{
	...
	if (keys[which])
		nappanic("metamap already exists");
